...
const Categories: React.FC = () => {
  ...
  const [editingCategory, setEditingCategory] = useState<Category | null>(null); // null means list mode, object means edit mode
  const [isCreating, setIsCreating] = useState(false); // true if creating new
  ...
  const handleCreate = () => {
    ...
    setEditingCategory({} as Category); // Dummy obj to show modal
    setIsCreating(true);
  };
