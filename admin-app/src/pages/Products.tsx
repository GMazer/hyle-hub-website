...
const Products: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-emerald-100 dark:border-gray-800 transition-colors">
      <div className="p-6 border-b border-emerald-100 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <button onClick={() => setEditingProduct(null)} className="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded hover:bg-emerald-700 transition-colors">
             ...
             filteredProducts.map(product => {
                ...
                return (
                  <tr key={product.id} className="hover:bg-emerald-50/50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td className="p-4 text-sm text-gray-600 dark:text-gray-400">{category?.name || 'Chưa phân loại'}</td>
